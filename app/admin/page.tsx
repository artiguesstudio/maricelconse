...
export default async function AdminPage() {
  ...
  const [content, subscriptions] = await Promise.all([getContentBundle(), getAdminSubscriptions()]);
  return (
    <main className="admin-shell">
      ...
      <AdminPanel initialContent={content} initialSubscriptions={subscriptions} />
    </main>
  );
}
