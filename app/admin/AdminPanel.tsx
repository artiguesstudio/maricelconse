...
const tabContent: Record<Tab, { title: string; description: string }> = {
  ...
  leads: { title: "Leads", description: "Conoce cómo llega cada alumna y qué espera lograr con la membresía." },
